...
if(isset($_GET["nom"]) && isset($_GET["prenom"]) && isset($_GET["age"]) && isset($_GET["nationalité"]) && isset($_GET["date de naissance"]))
{echo "<h2> votre nom ". $_GET["nom"]. " votre  prénom ".$_GET["prenom"]." votre age".$_GET["age"].$_GET["nationalité"]." votre nationalité".$_GET["date de naissance"]."votre date de naissance". "</h2>";}
echo '<tr>';
$j=1;
}
echo '</table>';
